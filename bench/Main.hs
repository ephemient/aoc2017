...
main = defaultMain
  ...
  , env (readDayInput 3) $ \input -> bgroup "Day 3"
  ...
  , env (getDayInput 10) $ \input -> bgroup "Day 10"
      [ bench "part 1" $ nf (day10a 256) input
  ...
  , env (getDayInput 16) $ \input -> bgroup "Day 16"
      [ bench "part 1" $ nf (day16a 16) input
      , bench "part 2" $ nf (day16b 16 1000000000) input
      ]
  ...
  , env (getDayInput 20) $ \input -> bgroup "Day 20"
      ...
      , bench "part 2" $ nf (length . day20b) input
      ]
  ]
